...
//tutor cards that appear in admin
const TutorCard = ({
  name,
  imageURL,
  education,
  ...
  //session form is passed down below in order to book a tutor session
  return (
    <>
      <div
      ...
      >
        <h1 class="title" style={{ color: "white", textAlign: "center" }}>
          {name}
        </h1>
        <p>
        ...
        <div style={{ fontSize: "18px" }}>
          ...
          <p>
            <strong style={{ color: "white" }}>Subjects(s):</strong> {subjects}
          </p>
          <p>
            <strong style={{ color: "white" }}>Experience(Yrs): </strong>
            {experience}
          </p>
          <p>
